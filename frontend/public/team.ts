...
export const team:TeamMember[] = [
  {
    name: 'Calvin Koh',
    role: 'UX Designer',
    bio: 'Responsible for designing mockups for the user experience',
    image: '/images-hardcoded/fake-calvin.png',
  },
  {
    name: 'Asra Khan',
    role: 'Product Manager',
    bio: 'The project\'s main coordinator, delegates tasks, reviews completed tasks, makes sure everyone is on track and other cool stuff too',
    image: '/images-hardcoded/fake-asra.png',
  },
  {
  ...
  },
  {
    name: 'Finn Gurry',
    role: 'Developer',
    bio: 'Develops other tihngs and is a pretty cool bloke',
    image: '/images-hardcoded/fake-finn.png',
  },
  {
    name: 'Bohan Chen',
